...
export default function MiniGamePage() {
  ...
  const handleComplete = async () => {
    ...
    const pointsReward = parseInt(urlParams.get('points') || '3');
    actions.addCollaborationPoints(pointsReward);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-orange-100 via-yellow-50 to-pink-100">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-orange-800">今日のミニゲームは完了済みです</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-pink-50 px-4 py-8">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        {gamePhase === 'intro' && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
            <div className="text-center space-y-4">
              <h1 className="text-3xl font-bold gradient-text">ミニゲーム 🎮</h1>
              <p className="text-gray-600">楽しく遊びながらAiconの個性を育てよう！</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <div className="space-y-4">
                  ...
                  <h3 className="text-xl font-bold text-rose-800">{mockDramaScenario.title}</h3>
              ...
              >
                <div className="space-y-4">
                  ...
                  <h3 className="text-xl font-bold text-violet-800">{mockRhythmGame.title}</h3>
        ...
        {gamePhase === 'playing' && gameType === 'drama' && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">{mockDramaScenario.title}</h2>
              <ProgressBar
              ...
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <div className="p-4 bg-gray-50 rounded-2xl">
                    <p className="text-gray-700 font-medium">{mockDramaScenario.steps[currentStep]?.situation}</p>
                  </div>
                </div>
        ...
        {gamePhase === 'playing' && gameType === 'rhythm' && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">{mockRhythmGame.title}</h2>
              <p className="text-gray-600">{mockRhythmGame.description}</p>
              <ProgressBar current={rhythmBeats.length} total={8} color="secondary" showLabel={false} />
            </div>
            ...
            >
              <div className="space-y-6 text-center">
                ...
                <div className="space-y-4">
                  <p className="font-medium text-cyan-800">音楽に合わせて感情ボタンを押そう！</p>
        ...
        {gamePhase === 'complete' && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-6">
            <div className="text-6xl mb-4">🎉</div>
            <h2 className="text-3xl font-bold gradient-text">ゲーム完了！</h2>
            <p className="text-xl text-gray-600">素晴らしいプレイでした！</p>
            ...
            >
              <div className="space-y-4">
                ...
                <h3 className="text-xl font-bold text-emerald-800">最終スコア: {score}</h3>
                <p className="text-emerald-700">あなたの判断からAiconが多くを学びました！</p>
        ...
        {gamePhase === 'results' && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800">ゲーム結果</h2>
            ...
            >
              <div className="space-y-4">
                ...
                <div className="p-4 bg-gradient-to-r from-green-100 to-emerald-100 rounded-2xl border border-green-200">
                  ...
                  <p className="text-sm text-green-600">Aiconの個性パラメータが更新されました</p>
                </div>
              </div>
            </motion.div>
