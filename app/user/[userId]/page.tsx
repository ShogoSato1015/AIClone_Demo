          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-8">
              ...
              <div className="mt-4 space-y-2">
                <div className="flex justify-center flex-wrap gap-2">
                  {userData.clone.titleBadges.map((badge) => (
                    <span
                      key={badge}
                      className="px-3 py-1 bg-purple-200/80 text-purple-800 rounded-full text-sm font-medium border border-purple-300"
                    >
                      {badge}
                    </span>
                  ))}
                </div>
                <div className="text-sm text-purple-600">レベル {userData.clone.level}</div>
              </div>
            </div>
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="space-y-4">
                <div>
                  <h1 className="text-4xl font-bold gradient-text mb-2">{userData.nickname}</h1>
                ...
                {!isOwnProfile && (
                  <div className="flex justify-center lg:justify-start space-x-4">
                    ...
                    <Button variant="outline">❤️ フォロー</Button>
                  </div>
                )}
              </div>
            </div>
                    ...
                    >
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="text-3xl">{work.theme === '漫才' ? '🎭' : '🎵'}</div>
                          <span className="text-xs px-2 py-1 bg-indigo-100 text-indigo-700 rounded-full">
                            {work.theme}
                          </span>
                        </div>

                        <h3 className="font-bold text-indigo-800 line-clamp-2">{work.ogMeta.title}</h3>
                    ...
                    >
                      <div className="text-center space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-pink-600">{collaborator.collaborationCount}回のコラボ</p>
                        </div>
                        <Button
                          onClick={(e) => {
                            e?.stopPropagation();
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-white/90 to-cyan-50/90 backdrop-blur-sm border-2 border-cyan-200/50 rounded-3xl p-6 shadow-lg">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <span className="text-sm text-cyan-600">Aiconタイプ</span>
